...
app.use(cors({
  origin: '*', // para desarrollo; en producción limita a tus dominios, este origin me sirve para todo url ? o deberia mejor poner la url correcta q me ngrok ahora ? entonces falta algo en un ujemplo me dice asi origin: ['http://localhost:3000', 'https://6f87d7429439.ngrok-free.app'], y al parecer me falat esto app.options('*', cors()); Necesario para que el preflight OPTIONS responda ok
  credentials: true,
